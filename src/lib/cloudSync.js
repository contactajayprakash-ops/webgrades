...
// NOTE: reading the grade snapshot moved to src/lib/snapshotRead.js, which hits
// the Firestore REST API directly (no SDK) so cold-open paint doesn't wait on the
// ~140 KB firebase chunk. This module stays for settings/agenda sync only.
